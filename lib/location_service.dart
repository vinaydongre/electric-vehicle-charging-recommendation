...
class LocationService {
  ...
  Future<Map<String, dynamic>> getDirections(
    ...
    var json = convert.jsonDecode(response.body);
    var results = {
      'bounds_ne': json['route'][0]['bounds']['northeast'],
      'bounds_sw': json['route'][0]['bounds']['southwest'],
      'start_location': json['route'][0]['legs'][0]['start_location'],
      'end_location': json['route'][0]['legs'][0]['end_location'],
      'polyline': json['route'][0]['overview_polyline']['points'],
      'polyline_decoded': PolylinePoints()
          .decodePolyline(json['route'][0]['overview_polyline']['points']),
    };
    print(results);
    return results;
  }
